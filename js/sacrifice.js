    ...
    stuff: {
                ...
                content: [
                    ...
                    content: [
                        ...
                        ["display-text", () => "You have <h2 style='color: white; text-shadow: 0 0 10px blue'>" + formatWhole(player.sa.challengepent) + "</h2> Challenge Pentational, pentating SP, CP, CE and crystal stages gain by<h2 style='color: white; text-shadow: 0 0 10px green'>" + " ^^^" + format(player.sa.challengepent.max(1).tetr(6)) + "</h2>.<br>"],
                        ["challenges", [1,2,3,4]]
