...
effectDescription(){
  ...
  upgrades: {
        ...
        23: { title: "133",
        description: "Divide Ascension cost based on points.",
        cost: new Decimal("11"),
        effect() {
    ...
    color: "#4D4B4B",
    requires: new Decimal("1e8300"), // Can be a function that takes requirement increases into account
    ...
    canBuyMax() { return hasMilestone("d", 4) },
    resetsNothing() {return hasMilestone("f", 4)},
    hotkeys: [
